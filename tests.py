...
class URLTest(unittest.TestCase):
    ...
    def test_DPS(self):
        ...
        self.assertEqual(self.client.get('/DUlSine/3802/DPS/nouveau/123456ref1231/organisateur').status_code, 301)
        self.assertEqual(self.client.get('/DUlSine/3802/DPS/nouveau/123456ref1231/organisateur/').status_code, 200)
        self.assertEqual(self.client.get('/DUlSine/3802/DPS/nouveau/123456ref1231/manifestation').status_code, 301)
        self.assertEqual(self.client.get('/DUlSine/3802/DPS/nouveau/123456ref1231/manifestation/').status_code, 200)
        self.assertEqual(self.client.get('/DUlSine/3802/DPS/nouveau/123456ref1231/dimenssionnement').status_code, 404)
        self.assertEqual(self.client.get('/DUlSine/3802/DPS/nouveau/123456ref1231/dimenssionnement/12345').status_code, 301)
        self.assertEqual(self.client.get('/DUlSine/3802/DPS/nouveau/123456ref1231/dimenssionnement/12345/').status_code, 200)
